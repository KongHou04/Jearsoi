...
{
    /// <inheritdoc />
    public partial class jearsoidb_01 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CpTypeId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_couponTypes", x => x.CpTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_coupons_couponTypes_CpTypeId",
                        column: x => x.CpTypeId,
                        principalTable: "couponTypes",
                        principalColumn: "CpTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_productDiscounts", x => x.PDId);
                    table.ForeignKey(
